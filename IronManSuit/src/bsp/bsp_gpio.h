...
#define BSP_LEDS_INIT()    { BSP_LED0_INIT(); BSP_LED1_INIT(); BSP_LED2_INIT(); BSP_LED3_INIT(); BSP_LED4_INIT();}
#define BSP_BTNS_INIT()    { BSP_BTN0_INIT(); BSP_BTN1_INIT(); BSP_BTN2_INIT(); BSP_BTN3_INIT(); BSP_BTN4_INIT();}

#define BSP_LEDS_ON()      { BSP_LED0_ON();     BSP_LED1_ON();     BSP_LED2_ON();     BSP_LED3_ON();     BSP_LED4_ON();}
#define BSP_LEDS_OFF()     { BSP_LED0_OFF();    BSP_LED1_OFF();    BSP_LED2_OFF();    BSP_LED3_OFF();    BSP_LED4_OFF();}
#define BSP_LEDS_TOGGLE()  { BSP_LED0_TOGGLE(); BSP_LED1_TOGGLE(); BSP_LED2_TOGGLE(); BSP_LED3_TOGGLE(); BSP_LED4_TOGGLE();}
